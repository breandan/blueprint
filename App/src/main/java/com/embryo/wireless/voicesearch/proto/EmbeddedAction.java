package com.embryo.wireless.voicesearch.proto;
...
public final class EmbeddedAction {
    public static final class EmbeddedActionContact
        ...
        public int getSerializedSize() {
            ...
            if (hasSynced()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeBoolSize(2, getSynced());
            }
            if (hasMerged()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeBoolSize(3, getMerged());
            }
            this.cachedSize = i;
            return i;
        }
        ...
        public EmbeddedActionContact mergeFrom(com.embryo.protobuf.micro.CodedInputStreamMicro paramCodedInputStreamMicro)
                throws IOException {
            for (; ; ) {
