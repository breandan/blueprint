        ...
        try {
            ...
            if (localStringBuilder != null) {
                if (this.mGreco3Grammar.isAddContacts()) {
                    List localList = new LinkedList<com.embryo.android.speech.grammar.GrammarContact>();
                    ...
                    while (localIterator.hasNext()) {
                        localContactsGrammarBuilder.addContact((com.embryo.android.speech.grammar.GrammarContact) localIterator.next());
                    }
 ...
 * Qualified Name:     HandsFreeGrammarCompiler
