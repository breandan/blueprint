...
public class ContactsGrammarBuilder
    ...
    private final ArrayList<com.embryo.android.speech.grammar.GrammarContact> mGrammarContactList = Lists.newArrayList();
    ...
    private void calculateWeight() {
        ...
        for(com.embryo.android.speech.grammar.GrammarContact grammarContact : mGrammarContactList) {
    ...
    public void addContact(com.embryo.android.speech.grammar.GrammarContact paramGrammarContact) {
    ...
    protected Collection<com.embryo.android.speech.grammar.GrammarToken> getGrammarTokens() {
        calculateWeight();
        HashMap localHashMap = Maps.newHashMap();
        Iterator localIterator = this.mGrammarContactList.iterator();
        while (localIterator.hasNext()) {
            ((com.embryo.android.speech.grammar.GrammarContact) localIterator.next()).addTokens(localHashMap);
        }
 ...
 * Qualified Name:     ContactsGrammarBuilder
