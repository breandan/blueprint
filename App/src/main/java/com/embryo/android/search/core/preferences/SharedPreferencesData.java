...
public final class SharedPreferencesData
    ...
    public SharedPreferencesData mergeFrom(CodedInputStreamMicro input) throws IOException {
        ...
        if (!parseUnknownField(input, tag)) {
            switch (tag) {
                ...
                case 10: {
                    SharedPreferencesData.SharedPreferenceEntry value = new SharedPreferencesData.SharedPreferenceEntry();
 ...
 * Qualified Name:     com.embryo.android.search.core.preferences.SharedPreferencesData
