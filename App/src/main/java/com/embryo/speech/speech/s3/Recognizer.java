package com.embryo.speech.speech.s3;
...
public final class Recognizer {
    public static final class RecognizerEvent
        ...
        private com.embryo.speech.recognizer.api.RecognizerProtos.EndpointerEvent endpointerEvent_ = null;
        private boolean hasEndpointerEvent;
        private boolean hasLanguage;
        private boolean hasRecognitionEvent;
        private String language_ = "";
        private com.embryo.speech.recognizer.api.RecognizerProtos.RecognitionEvent recognitionEvent_ = null;
        ...
        public com.embryo.speech.recognizer.api.RecognizerProtos.EndpointerEvent getEndpointerEvent() {
            return this.endpointerEvent_;
        }

        public RecognizerEvent setEndpointerEvent(com.embryo.speech.recognizer.api.RecognizerProtos.EndpointerEvent paramEndpointerEvent) {
        ...
        public com.embryo.speech.recognizer.api.RecognizerProtos.RecognitionEvent getRecognitionEvent() {
            return this.recognitionEvent_;
        }

        public RecognizerEvent setRecognitionEvent(com.embryo.speech.recognizer.api.RecognizerProtos.RecognitionEvent paramRecognitionEvent) {
        ...
        public int getSerializedSize() {
            ...
            int i = 0;
            if (bool) {
                i = 0 + com.embryo.protobuf.micro.CodedOutputStreamMicro.computeMessageSize(1, getRecognitionEvent());
            }
            if (hasEndpointerEvent()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeMessageSize(2, getEndpointerEvent());
            }
            if (hasLanguage()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(3, getLanguage());
            }
            this.cachedSize = i;
            return i;
        }
        ...
        public RecognizerEvent mergeFrom(com.embryo.protobuf.micro.CodedInputStreamMicro paramCodedInputStreamMicro)
                throws IOException {
            for (; ; ) {
                ...
                switch (i) {
                    ...
                    case 0:
                        return this;
                    case 10:
                        com.embryo.speech.recognizer.api.RecognizerProtos.RecognitionEvent localRecognitionEvent = new com.embryo.speech.recognizer.api.RecognizerProtos.RecognitionEvent();
                        paramCodedInputStreamMicro.readMessage(localRecognitionEvent);
                        setRecognitionEvent(localRecognitionEvent);
                        break;
                    case 18:
                        com.embryo.speech.recognizer.api.RecognizerProtos.EndpointerEvent localEndpointerEvent = new com.embryo.speech.recognizer.api.RecognizerProtos.EndpointerEvent();
    ...
    public static final class RecognizerVocabularyContext
            extends com.embryo.protobuf.micro.MessageMicro {
        private int cachedSize = -1;
        private List<com.embryo.speech.util.Contacts.TopContact> topContact_ = Collections.emptyList();

        public RecognizerVocabularyContext addTopContact(com.embryo.speech.util.Contacts.TopContact paramTopContact) {
        ...
        public int getSerializedSize() {
            ...
            while (localIterator.hasNext()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeMessageSize(1, (com.embryo.speech.util.Contacts.TopContact) localIterator.next());
            }
            this.cachedSize = i;
            return i;
        }

        public List<com.embryo.speech.util.Contacts.TopContact> getTopContactList() {
            return this.topContact_;
        }

        public RecognizerVocabularyContext mergeFrom(com.embryo.protobuf.micro.CodedInputStreamMicro paramCodedInputStreamMicro)
                throws IOException {
            for (; ; ) {
                int i = paramCodedInputStreamMicro.readTag();
                switch (i) {
                    default:
                        ...
                        com.embryo.speech.util.Contacts.TopContact localTopContact = new com.embryo.speech.util.Contacts.TopContact();
        ...
        public void writeTo(com.embryo.protobuf.micro.CodedOutputStreamMicro paramCodedOutputStreamMicro)
            ...
            Iterator localIterator = getTopContactList().iterator();
            while (localIterator.hasNext()) {
                paramCodedOutputStreamMicro.writeMessage(1, (com.embryo.speech.util.Contacts.TopContact) localIterator.next());
            }
        }
    }
    ...
    public static final class S3RecognizerInfo
            extends com.embryo.protobuf.micro.MessageMicro {
        private com.embryo.speech.common.Alternates.AlternateParams alternateParams_ = null;
        private int cachedSize = -1;
        ...
        private com.embryo.speech.common.proto.RecognitionContextProto.RecognitionContext recognitionContext_ = null;
        private int resetIntervalMs_ = 0;

        public com.embryo.speech.common.Alternates.AlternateParams getAlternateParams() {
            return this.alternateParams_;
        }

        public S3RecognizerInfo setAlternateParams(com.embryo.speech.common.Alternates.AlternateParams paramAlternateParams) {
        ...
        public com.embryo.speech.common.proto.RecognitionContextProto.RecognitionContext getRecognitionContext() {
            return this.recognitionContext_;
        }

        public S3RecognizerInfo setRecognitionContext(com.embryo.speech.common.proto.RecognitionContextProto.RecognitionContext paramRecognitionContext) {
        ...
        public int getSerializedSize() {
            ...
            int i = 0;
            if (bool) {
                i = 0 + com.embryo.protobuf.micro.CodedOutputStreamMicro.computeMessageSize(1, getRecognitionContext());
            }
            if (hasMaxNbest()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeInt32Size(3, getMaxNbest());
            }
            if (hasAlternateParams()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeMessageSize(4, getAlternateParams());
            }
            if (hasEnablePartialResults()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeBoolSize(5, getEnablePartialResults());
            }
            if (hasEnableLattice()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeBoolSize(6, getEnableLattice());
            }
            if (hasProfanityFilter()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeInt32Size(7, getProfanityFilter());
            }
            if (hasConfidenceThreshold()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeFloatSize(8, getConfidenceThreshold());
            }
            if (hasGrammarParams()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeMessageSize(9, getGrammarParams());
            }
            if (hasCondition()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(10, getCondition());
            }
            if (hasDictationMode()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeBoolSize(11, getDictationMode());
            }
            if (hasEnableSemanticResults()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeBoolSize(12, getEnableSemanticResults());
            }
            if (hasEnableAlternates()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeBoolSize(13, getEnableAlternates());
            }
            if (hasEnableCombinedNbest()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeBoolSize(14, getEnableCombinedNbest());
            }
            if (hasGreco2CompatMode()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeBoolSize(15, getGreco2CompatMode());
            }
            if (hasEnablePersonalization()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeBoolSize(16, getEnablePersonalization());
            }
            if (hasLoggingDataRequested()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeBoolSize(17, getLoggingDataRequested());
            }
            if (hasLogFeaturesOnly()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeBoolSize(18, getLogFeaturesOnly());
            }
            if (hasResetIntervalMs()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeInt32Size(19, getResetIntervalMs());
            }
            if (hasEnableEndpointerEvents()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeBoolSize(20, getEnableEndpointerEvents());
            }
            if (hasEnablePartialNbest()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeBoolSize(21, getEnablePartialNbest());
            }
            this.cachedSize = i;
            return i;
        }
        ...
        public S3RecognizerInfo mergeFrom(com.embryo.protobuf.micro.CodedInputStreamMicro paramCodedInputStreamMicro)
                throws IOException {
            for (; ; ) {
                int i = paramCodedInputStreamMicro.readTag();
                switch (i) {
                    ...
                    case 0:
                        return this;
                    case 10:
                        com.embryo.speech.common.proto.RecognitionContextProto.RecognitionContext localRecognitionContext = new com.embryo.speech.common.proto.RecognitionContextProto.RecognitionContext();
                    ...
                    case 24:
                        ...
                        break;
                    case 34:
                        com.embryo.speech.common.Alternates.AlternateParams localAlternateParams = new com.embryo.speech.common.Alternates.AlternateParams();
        ...
        public static final class GrammarSelectorParams
            ...
            public int getSerializedSize() {
                ...
                int i = 0;
                if (bool) {
                    i = 0 + com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(1, getSelectedApplication());
                }
                if (hasSelectedSlot()) {
                    i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(2, getSelectedSlot());
                }
                this.cachedSize = i;
                return i;
            }
            ...
            public GrammarSelectorParams mergeFrom(com.embryo.protobuf.micro.CodedInputStreamMicro paramCodedInputStreamMicro)
                    throws IOException {
                for (; ; ) {
                    int i = paramCodedInputStreamMicro.readTag();
                    switch (i) {
