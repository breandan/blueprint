package com.embryo.speech.decoder.common;
...
public final class Alignment {
    public static final class AlignmentProto
        ...
        public int getSerializedSize() {
            ...
            int i = 0;
            if (bool) {
                i = 0 + com.embryo.protobuf.micro.CodedOutputStreamMicro.computeFloatSize(1, getFrameDuration());
            }
            if (hasTotalCost()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeFloatSize(2, getTotalCost());
            }
            if (hasAmCost()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeFloatSize(3, getAmCost());
            }
            if (hasLmCost()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeFloatSize(4, getLmCost());
            }
            Iterator localIterator = getSegmentList().iterator();
            while (localIterator.hasNext()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeGroupSize(5, (Segment) localIterator.next());
            }
            if (hasItableChecksum()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(17, getItableChecksum());
            }
            if (hasItableFilename()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(18, getItableFilename());
            }
            if (hasOtableChecksum()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(19, getOtableChecksum());
            }
            if (hasOtableFilename()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(20, getOtableFilename());
            }
            if (hasWordLabelPosition()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeInt32Size(21, getWordLabelPosition());
            }
            this.cachedSize = i;
            return i;
        }
        ...
        public static final class Segment
            ...
            public int getSerializedSize() {
                ...
                int i = 0;
                if (bool) {
                    i = 0 + com.embryo.protobuf.micro.CodedOutputStreamMicro.computeInt64Size(6, getStart());
                }
                if (hasEnd()) {
                    i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeInt64Size(7, getEnd());
                }
                if (hasCost()) {
                    i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeFloatSize(8, getCost());
                }
                if (hasAmCost()) {
                    i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeFloatSize(9, getAmCost());
                }
                if (hasLmCost()) {
                    i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeFloatSize(10, getLmCost());
                }
                if (hasIlabel()) {
                    i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeInt64Size(11, getIlabel());
                }
                if (hasOlabel()) {
                    i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeInt64Size(12, getOlabel());
                }
                if (hasIlabelStr()) {
                    i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(13, getIlabelStr());
                }
                if (hasOlabelStr()) {
                    i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(14, getOlabelStr());
                }
                int j = 0;
                Iterator localIterator = getStatesList().iterator();
                while (localIterator.hasNext()) {
                    j += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeInt64SizeNoTag(((Long) localIterator.next()).longValue());
                }
                int k = i + j + 1 * getStatesList().size();
                if (hasConfidence()) {
                    k += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeFloatSize(16, getConfidence());
                }
                this.cachedSize = k;
                return k;
            }
