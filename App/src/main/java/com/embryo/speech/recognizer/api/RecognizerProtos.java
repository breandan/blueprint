...
import com.embryo.speech.decoder.common.Alignment;
...
public final class RecognizerProtos {
    ...
    public static final class Hypothesis
        ...
        private List<com.embryo.speech.decoder.confidence.ConfFeature.WordConfFeature> wordConfFeature_ = Collections.emptyList();

        public Hypothesis addWordConfFeature(com.embryo.speech.decoder.confidence.ConfFeature.WordConfFeature paramWordConfFeature) {
        ...
        public int getSerializedSize() {
            ...
            while (localIterator.hasNext()) {
                i += CodedOutputStreamMicro.computeMessageSize(5, (com.embryo.speech.decoder.confidence.ConfFeature.WordConfFeature) localIterator.next());
            }
            if (hasAlternates()) {
        ...
        public List<com.embryo.speech.decoder.confidence.ConfFeature.WordConfFeature> getWordConfFeatureList() {
            ...
            for (; ; ) {
                ...
                switch (i) {
                    ...
                    case 34:
                        ...
                        break;
                    case 42:
                        com.embryo.speech.decoder.confidence.ConfFeature.WordConfFeature localWordConfFeature = new com.embryo.speech.decoder.confidence.ConfFeature.WordConfFeature();
        ...
        public void writeTo(CodedOutputStreamMicro paramCodedOutputStreamMicro)
            ...
            Iterator localIterator = getWordConfFeatureList().iterator();
            while (localIterator.hasNext()) {
                paramCodedOutputStreamMicro.writeMessage(5, (com.embryo.speech.decoder.confidence.ConfFeature.WordConfFeature) localIterator.next());
            }
            if (hasAlternates()) {
    ...
    public static final class PartialResult
        ...
        private com.embryo.protobuf.micro.ByteStringMicro latticeFst_ = com.embryo.protobuf.micro.ByteStringMicro.EMPTY;
        ...
        public PartialResult addWordConfFeature(com.embryo.speech.decoder.confidence.ConfFeature.WordConfFeature paramWordConfFeature) {
            if (paramWordConfFeature == null) {
                throw new NullPointerException();
            }
            if (this.wordConfFeature_.isEmpty()) {
        ...
        public com.embryo.protobuf.micro.ByteStringMicro getLatticeFst() {
        ...
        public int getSerializedSize() {
            ...
            while (localIterator2.hasNext()) {
                i += CodedOutputStreamMicro.computeMessageSize(6, (com.embryo.speech.decoder.confidence.ConfFeature.WordConfFeature) localIterator2.next());
            }
        ...
        public PartialResult setLatticeFst(com.embryo.protobuf.micro.ByteStringMicro paramByteStringMicro) {
        ...
        public void writeTo(CodedOutputStreamMicro paramCodedOutputStreamMicro)
            ...
            Iterator localIterator2 = getWordConfFeatureList().iterator();
            while (localIterator2.hasNext()) {
                paramCodedOutputStreamMicro.writeMessage(6, (com.embryo.speech.decoder.confidence.ConfFeature.WordConfFeature) localIterator2.next());
            }
            if (hasHotwordConfFeature()) {
    ...
    public static final class RecognitionResult
        ...
        public RecognitionResult setLatticeFst(com.embryo.protobuf.micro.ByteStringMicro paramByteStringMicro) {
            this.hasLatticeFst = true;
            this.latticeFst_ = paramByteStringMicro;
            return this;
        }
 ...
 * Qualified Name:     RecognizerProtos
