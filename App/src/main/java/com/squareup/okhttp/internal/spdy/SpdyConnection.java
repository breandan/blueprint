  ...
  implements Closeable
{
  ...
  static
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      executor = new ThreadPoolExecutor(0, 2147483647, 60L, TimeUnit.SECONDS, new SynchronousQueue(), Util.daemonThreadFactory("OkHttp SpdyConnection"));
      return;
    }
  }
  ...
  {
    // Byte code:
    //   0: getstatic 43	com/squareup/okhttp/internal/spdy/SpdyConnection:$assertionsDisabled	Z
    //   3: ifne +18 -> 21
    //   6: aload_0
    //   7: invokestatic 213	java/lang/Thread:holdsLock	(Ljava/lang/Object;)Z
    //   10: ifeq +11 -> 21
    //   13: new 215	java/lang/AssertionError
    //   16: dup
    //   17: invokespecial 216	java/lang/AssertionError:<init>	()V
    //   20: athrow
    //   21: aconst_null
    //   22: astore_3
    //   23: aload_0
    //   24: iload_1
    //   25: invokevirtual 219	com/squareup/okhttp/internal/spdy/SpdyConnection:shutdown	(I)V
    //   28: aload_0
    //   29: monitorenter
    //   30: aload_0
    //   31: getfield 79	com/squareup/okhttp/internal/spdy/SpdyConnection:streams	Ljava/util/Map;
    ...
    //   46: ifne +48 -> 94
    //   49: aload_0
    //   50: getfield 79	com/squareup/okhttp/internal/spdy/SpdyConnection:streams	Ljava/util/Map;
    //   53: invokeinterface 228 1 0
    //   58: aload_0
    //   59: getfield 79	com/squareup/okhttp/internal/spdy/SpdyConnection:streams	Ljava/util/Map;
    //   62: invokeinterface 232 1 0
    //   67: anewarray 234	com/squareup/okhttp/internal/spdy/SpdyStream
    //   70: invokeinterface 240 2 0
    //   75: checkcast 242	[Lcom/squareup/okhttp/internal/spdy/SpdyStream;
    //   78: astore 7
    //   80: aload_0
    //   81: getfield 79	com/squareup/okhttp/internal/spdy/SpdyConnection:streams	Ljava/util/Map;
    //   84: invokeinterface 245 1 0
    //   89: aload_0
    //   90: iconst_0
    //   91: invokespecial 249	com/squareup/okhttp/internal/spdy/SpdyConnection:setIdle	(Z)V
    //   94: aload_0
    //   95: getfield 251	com/squareup/okhttp/internal/spdy/SpdyConnection:pings	Ljava/util/Map;
    //   98: astore 8
    //   100: aconst_null
    //   101: astore 9
    //   103: aload 8
    //   105: ifnull +39 -> 144
    //   108: aload_0
    //   109: getfield 251	com/squareup/okhttp/internal/spdy/SpdyConnection:pings	Ljava/util/Map;
    //   112: invokeinterface 228 1 0
    //   117: aload_0
    //   118: getfield 251	com/squareup/okhttp/internal/spdy/SpdyConnection:pings	Ljava/util/Map;
    //   121: invokeinterface 232 1 0
    //   126: anewarray 253	com/squareup/okhttp/internal/spdy/Ping
    //   129: invokeinterface 240 2 0
    //   134: checkcast 255	[Lcom/squareup/okhttp/internal/spdy/Ping;
    //   137: astore 9
    //   139: aload_0
    //   140: aconst_null
    //   141: putfield 251	com/squareup/okhttp/internal/spdy/SpdyConnection:pings	Ljava/util/Map;
    //   144: aload_0
    //   145: monitorexit
    //   146: aload 7
    //   148: ifnull +68 -> 216
    ...
    //   177: aload 18
    //   179: iload_2
    //   180: invokevirtual 257	com/squareup/okhttp/internal/spdy/SpdyStream:close	(I)V
    //   183: iinc 17 1
    //   186: goto -23 -> 163
    //   189: astore 4
    //   191: aload 4
    ...
    //   242: iload 14
    //   244: aaload
    //   245: invokevirtual 260	com/squareup/okhttp/internal/spdy/Ping:cancel	()V
    //   248: iinc 14 1
    //   251: goto -18 -> 233
    //   254: aload_0
    //   255: getfield 109	com/squareup/okhttp/internal/spdy/SpdyConnection:spdyReader	Lcom/squareup/okhttp/internal/spdy/SpdyReader;
    //   258: invokevirtual 262	com/squareup/okhttp/internal/spdy/SpdyReader:close	()V
    //   261: aload_0
    //   262: getfield 120	com/squareup/okhttp/internal/spdy/SpdyConnection:spdyWriter	Lcom/squareup/okhttp/internal/spdy/SpdyWriter;
    //   265: invokevirtual 263	com/squareup/okhttp/internal/spdy/SpdyWriter:close	()V
    //   268: aload_3
    //   269: ifnull +25 -> 294
    //   272: aload_3
    //   273: athrow
  ...
  private Ping removePing(int paramInt)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 251	com/squareup/okhttp/internal/spdy/SpdyConnection:pings	Ljava/util/Map;
    //   6: ifnull +24 -> 30
    //   9: aload_0
    //   10: getfield 251	com/squareup/okhttp/internal/spdy/SpdyConnection:pings	Ljava/util/Map;
    //   13: iload_1
    //   14: invokestatic 269	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   17: invokeinterface 276 2 0
    //   22: checkcast 253	com/squareup/okhttp/internal/spdy/Ping
    //   25: astore_3
    //   26: aload_0
    //   27: monitorexit
    //   28: aload_3
  ...
  private void writePingLater(final int paramInt, final Ping paramPing)
  {
    ...
    localExecutorService.submit(new NamedRunnable("OkHttp SPDY Writer %s ping %d", arrayOfObject)
    {
      public void execute()
      {
        try
  ...
  public boolean isIdle()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 87	com/squareup/okhttp/internal/spdy/SpdyConnection:idleStartTimeNs	J
    //   6: lstore_2
    //   7: lload_2
    //   8: lconst_0
    //   9: lcmp
  ...
  void writeSynResetLater(final int paramInt1, final int paramInt2)
  {
    ...
    localExecutorService.submit(new NamedRunnable("OkHttp SPDY Writer %s stream %d", arrayOfObject)
    {
      public void execute()
      {
        try
  ...
  private class Reader
    implements SpdyReader.Handler, Runnable
  {
    private Reader() {}
    ...
    public void synStream(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, List<String> paramList)
    {
      ...
      localExecutorService.submit(new NamedRunnable("OkHttp SPDY Callback %s stream %d", arrayOfObject)
      {
        public void execute()
        {
          try
