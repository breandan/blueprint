...
public class HttpEngine
{
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      localCacheResponse = localOkResponseCache.get(this.uri, this.method, this.requestHeaders.getHeaders().toMultimap(false));
    ...
    throws IOException
  {
    ...
    } while (this.connection.getRoute().getProxy() == this.client.getProxy());
    this.requestHeaders.getHeaders().setRequestLine(getRequestLine());
  }
