  ...
  extends ResponseCache
{
    ...
    throws IOException
  {
    ...
    for (;;)
    {
      ...
      String str = localHttpURLConnection.getRequestMethod();
      if ((!maybeRemove(str, paramURI)) && (str.equals("GET")))
      {
        ...
        if (localHttpEngine != null)
        {
          ...
          if (!localResponseHeaders.hasVaryAll())
          {
            ...
            try
            {
              localEditor = this.cache.edit(uriToKey(paramURI));
              if (localEditor != null)
              {
                localEntry.writeTo(localEditor);
  ...
  private static final class Entry
  {
      ...
      throws IOException
    {
      ...
      SSLSocket localSSLSocket = getSslSocket(paramHttpURLConnection);
      if (localSSLSocket != null) {
        this.cipherSuite = localSSLSocket.getSession().getCipherSuite();
      }
      try
      {
      ...
      this.localCertificates = localSSLSocket.getSession().getLocalCertificates();
      return;
      this.cipherSuite = null;
      this.peerCertificates = null;
    ...
    private SSLSocket getSslSocket(HttpURLConnection paramHttpURLConnection)
    {
      ...
      for (HttpEngine localHttpEngine = ((HttpsURLConnectionImpl)paramHttpURLConnection).getHttpEngine(); (localHttpEngine instanceof HttpsEngine); localHttpEngine = ((HttpURLConnectionImpl)paramHttpURLConnection).getHttpEngine()) {
        return ((HttpsEngine)localHttpEngine).getSslSocket();
      }
      return null;
    }
      ...
      throws IOException
    {
      ...
      //   15: areturn
      //   16: ldc 172
      //   18: invokestatic 178	java/security/cert/CertificateFactory:getInstance	(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
      //   21: astore 4
      //   23: iload_2
      //   24: anewarray 180	java/security/cert/Certificate
      //   27: astore 5
      //   29: iconst_0
      //   30: istore 6
      //   32: iload 6
      ...
      //   42: iload 6
      //   44: aload 4
      //   46: new 182	java/io/ByteArrayInputStream
      //   49: dup
      //   50: aload_1
      //   51: invokevirtual 36	com/squareup/okhttp/internal/StrictLineReader:readLine	()Ljava/lang/String;
      //   54: ldc 184
      //   56: invokevirtual 188	java/lang/String:getBytes	(Ljava/lang/String;)[B
      //   59: invokestatic 194	com/squareup/okhttp/internal/Base64:decode	([B)[B
      //   62: invokespecial 197	java/io/ByteArrayInputStream:<init>	([B)V
      //   65: invokevirtual 201	java/security/cert/CertificateFactory:generateCertificate	(Ljava/io/InputStream;)Ljava/security/cert/Certificate;
      //   68: aastore
      //   69: iinc 6 1
      //   72: goto -40 -> 32
      //   75: astore_3
      ...
      //   79: dup
      //   80: aload_3
      //   81: invokevirtual 204	java/security/cert/CertificateException:getMessage	()Ljava/lang/String;
      ...
      throws IOException
    {
      ...
      //   4: aload_1
      //   5: ldc 210
      //   7: invokevirtual 215	java/io/Writer:write	(Ljava/lang/String;)V
      //   10: return
      //   11: aload_1
      ...
      //   19: aload_2
      //   20: arraylength
      //   21: invokestatic 220	java/lang/Integer:toString	(I)Ljava/lang/String;
      //   24: invokevirtual 76	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
      //   27: bipush 10
      //   29: invokevirtual 223	java/lang/StringBuilder:append	(C)Ljava/lang/StringBuilder;
      //   32: invokevirtual 81	java/lang/StringBuilder:toString	()Ljava/lang/String;
      //   35: invokevirtual 215	java/io/Writer:write	(Ljava/lang/String;)V
      //   38: aload_2
      //   39: arraylength
      //   40: istore 4
      //   42: iconst_0
      ...
      //   53: iload 5
      //   55: aaload
      //   56: invokevirtual 227	java/security/cert/Certificate:getEncoded	()[B
      //   59: invokestatic 231	com/squareup/okhttp/internal/Base64:encode	([B)Ljava/lang/String;
      //   62: astore 6
      //   64: aload_1
      ...
      //   77: bipush 10
      //   79: invokevirtual 223	java/lang/StringBuilder:append	(C)Ljava/lang/StringBuilder;
      //   82: invokevirtual 81	java/lang/StringBuilder:toString	()Ljava/lang/String;
      //   85: invokevirtual 215	java/io/Writer:write	(Ljava/lang/String;)V
      //   88: iinc 5 1
      //   91: goto -46 -> 45
      //   94: astore_3
      ...
      //   98: dup
      //   99: aload_3
      //   100: invokevirtual 232	java/security/cert/CertificateEncodingException:getMessage	()Ljava/lang/String;
