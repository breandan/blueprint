    ...
    public static final class ClientDataHeader
        ...
        public int getSerializedSize() {
            ...
            if (hasConfigTimeUsec()) {
                j += CodedOutputStreamMicro.computeInt64Size(2, getConfigTimeUsec());
            }
            this.cachedSize = j;
            return j;
        }
        ...
        public ClientDataHeader mergeFrom(CodedInputStreamMicro paramCodedInputStreamMicro)
                throws IOException {
            for (; ; ) {
 ...
 * Qualified Name:     com.google.webserver.shared.gws.experiments.ClientDataHeaderProto
