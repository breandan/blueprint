...
public class SwipeTutorialCardAdapter
  extends BaseEntryAdapter
{
  public SwipeTutorialCardAdapter(ActivityHelper paramActivityHelper)
  {
  ...
  public void onDismiss(Context paramContext, PredictiveCardContainer paramPredictiveCardContainer)
  {
    ...
    paramPredictiveCardContainer.recordFirstUseCardDismiss(2);
  }
}


/* Location:           C:\Cygwin\home\breandan\apk-tool\classes-dex2jar.jar
 * Qualified Name:     com.google.android.sidekick.shared.cards.SwipeTutorialCardAdapter
