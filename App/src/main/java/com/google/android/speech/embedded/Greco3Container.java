...
public class Greco3Container {
    ...
    public static Greco3Container create(Context paramContext, SharedPreferences paramSharedPreferences, ExecutorService paramExecutorService, Executor paramExecutor) {
        ...
        Greco3EngineManager localGreco3EngineManager = new Greco3EngineManager(localGreco3DataManager, localGreco3Preferences, new BundledEndpointerModelCopier(paramContext.getResources()));
 ...
 * Qualified Name:     com.google.android.speech.embedded.Greco3Container
