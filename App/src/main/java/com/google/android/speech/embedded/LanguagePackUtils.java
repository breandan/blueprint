...
public class LanguagePackUtils {
    ...
    public static Comparator<GstaticConfiguration.LanguagePack> newLanguagePackComparator(GstaticConfiguration.Configuration paramConfiguration) {
        final GstaticConfiguration.Configuration config = paramConfiguration;
        new Comparator<GstaticConfiguration.LanguagePack>() {
            public int compare(GstaticConfiguration.LanguagePack paramAnonymousLanguagePack1, GstaticConfiguration.LanguagePack paramAnonymousLanguagePack2) {
                int i = 1;
                String str1 = SpokenLanguageUtils.getDisplayName(config, paramAnonymousLanguagePack1.getBcp47Locale());
                String str2 = SpokenLanguageUtils.getDisplayName(config, paramAnonymousLanguagePack2.getBcp47Locale());
                int j;
                if (str1 == null) {
                    j = i;
                    if (str2 != null) {
