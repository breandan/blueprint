  ...
  implements RequestProducerFactory
{
  ...
  {
    if (this.mSessionParams.getMode() == 8) {}
    for (int i = 1;; i = 0) {
      return this.mExecutor.submit(new SoundSearchInfoBuilderTask(this.mSessionParams.isSoundSearchTtsEnabled(), this.mNrpp.getNetworkInformation(), this.mNrpp.getDeviceParams(), i));
    }
  }
