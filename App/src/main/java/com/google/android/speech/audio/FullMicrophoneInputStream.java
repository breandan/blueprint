...
public class FullMicrophoneInputStream
    ...
    public FullMicrophoneInputStream(int paramInt1, int paramInt2, boolean paramBoolean1, @Nullable SpeakNowSoundPlayer paramSpeakNowSoundPlayer, @Nullable AudioRouter paramAudioRouter, SpeechLibLogger paramSpeechLibLogger, boolean paramBoolean2) {
 ...
 * Qualified Name:     com.google.android.speech.audio.FullMicrophoneInputStream
