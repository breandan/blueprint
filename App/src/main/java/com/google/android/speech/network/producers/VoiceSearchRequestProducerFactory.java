  ...
  implements RequestProducerFactory
{
  ...
  private Future<Recognizer.RecognizerVocabularyContext> mRecognizerVocabularyContextFuture;
  ...
  private Future<Recognizer.RecognizerVocabularyContext> createRecognizerVocabularyContextFuture()
  {
    return this.mExecutor.submit(RecognizerVocabularyContextBuilderTask.getBuilder(this.mNrpp.getTopContactNamesSupplier()));
  }
  ...
  {
    return this.mExecutor.submit(new S3ClientInfoBuilderTask(this.mNrpp.getSpeechSettings(), this.mSessionParams.getApplicationId(), this.mNrpp.getDeviceParams(), this.mSessionParams.getTriggerApplication()));
  }
  ...
  public void init(@Nonnull SessionParams paramSessionParams)
  {
    ...
    this.mRecognizerVocabularyContextFuture = createRecognizerVocabularyContextFuture();
  }
  
  public S3RequestProducer newRequestProducer(InputStream paramInputStream)
  {
    Preconditions.checkNotNull(this.mSessionParams);
    return new Producers.CompositeProducer(new VoiceSearchHeaderProducer(this.mPinholeParamsFuture, this.mMobileUserInfoFuture, this.mS3ClientInfoFuture, this.mS3UserInfoFuture, this.mRecognizerVocabularyContextFuture, this.mS3AudioInfo, this.mS3RecognizerInfo, this.mRequestId, this.mService, this.mLogger, this.mNrpp.getSpeechSettings()), new AmrStreamProducer(paramInputStream, this.mSessionParams.getAudioInputParams().getEncoding(), 384));
  }
  ...
  public void refresh()
  {
    ...
    catch (IOException localIOException)
    {
      ...
      this.mS3UserInfoFuture = this.mExecutor.submit(S3UserInfoBuilderTask.getAuthTokenRefreshingBuilder(this.mNrpp.getAuthTokenHelper(), localS3UserInfo, this.mNrpp.getSpeechSettings()));
    }
  }
}
