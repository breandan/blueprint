...
public class AudioSource implements AudioInputStreamFactory {
    ...
    public AudioSource(int sampleRate, int readSize, int minBuffers, int maxBuffers, AudioInputStreamFactory inputStreamFactory, SpeechLevelSource speechLevelSource) {
    ...
    public synchronized void start(RecognitionEventListener listener) {
