  ...
  implements Multimap<K, V>, Serializable
{
  ...
  {
    RandomAccessWrappedList(@Nullable List<V> paramList, AbstractMultimap<K, V>.WrappedCollection paramAbstractMultimap)
    {
    ...
    extends AbstractCollection<V>
  {
    ...
    WrappedCollection(@Nullable Collection<V> paramCollection, AbstractMultimap<K, V>.WrappedCollection paramAbstractMultimap)
    {
      ...
      if (localObject == null) {}
      for (Collection localCollection = null;; localCollection = localObject.getDelegate())
      {
  ...
  private class WrappedList
    ...
    implements List<V>
  {
    WrappedList(@Nullable List<V> paramList, AbstractMultimap<K, V>.WrappedCollection paramAbstractMultimap)
    {
      super(paramList, paramAbstractMultimap, localWrappedCollection);
    }
  ...
  {
    WrappedSortedSet(@Nullable SortedSet<V> paramSortedSet, AbstractMultimap<K, V>.WrappedCollection paramAbstractMultimap)
    {
