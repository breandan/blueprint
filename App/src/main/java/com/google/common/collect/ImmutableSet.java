  ...
  implements Set<E>
{
  ...
  {
    int i = chooseTableSize(paramVarArgs.length);
    ...
    if (m < paramVarArgs.length)
    {
      ...
      for (int i1 = Hashing.smear(n);; i1++)
      {
        ...
        for (;;)
        {
          ...
          if (localArrayList == null)
          {
            localArrayList = new ArrayList(paramVarArgs.length);
            for (int i3 = 0; i3 < m; i3++) {
              localArrayList.add(paramVarArgs[i3]);
            }
          }
        }
      }
    ...
    if (localArrayList == null) {}
    for (Object[] arrayOfObject2 = paramVarArgs; arrayOfObject2.length == 1; arrayOfObject2 = localArrayList.toArray())
    {
