  ...
  implements ListeningExecutorService
{
    ...
    throws InterruptedException, ExecutionException, TimeoutException
  {
    ...
    //   0	391	0	this	AbstractListeningExecutorService
    //   0	391	1	paramCollection	Collection<? extends Callable<T>>
    //   0	391	2	paramBoolean	boolean
    //   0	391	3	paramLong	long
    //   6	80	5	i	int
    //   14	184	6	bool	boolean
    //   30	204	7	localArrayList	ArrayList
    //   40	285	8	localExecutorCompletionService	java.util.concurrent.ExecutorCompletionService
    //   49	271	9	l1	long
    //   231	120	11	localObject1	Object
    //   370	1	11	localObject2	Object
    //   240	13	12	localIterator1	Iterator
    //   57	62	14	localIterator2	Iterator
    //   86	26	16	j	int
    //   89	120	17	k	int
    //   92	295	18	localObject3	Object
    //   99	231	20	localFuture	Future
    //   345	40	21	localObject4	Object
    //   334	7	22	localRuntimeException	java.lang.RuntimeException
    //   378	3	23	localExecutionException	ExecutionException
    //   155	199	24	localObject5	Object
    //   164	13	25	localIterator3	Iterator
    //   279	6	27	localTimeUnit	TimeUnit
    //   307	11	28	l2	long
    //   226	133	30	localObject6	Object
    // Exception table:
    //   from	to	target	type
    //   46	51	231	finally
    //   51	82	231	finally
