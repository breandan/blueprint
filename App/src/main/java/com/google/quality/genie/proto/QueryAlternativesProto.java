    ...
    extends MessageMicro
  {
    ...
    public int getSerializedSize()
    {
      ...
      while (localIterator2.hasNext()) {
        j += CodedOutputStreamMicro.computeMessageSize(2, (QuerySegmentAlternatives)localIterator2.next());
      }
      this.cachedSize = j;
      return j;
    }
    
    public QueryAlternatives mergeFrom(CodedInputStreamMicro paramCodedInputStreamMicro)
      throws IOException
    {
      for (;;)
      {
      ...
      extends MessageMicro
    {
      ...
      public int getSerializedSize()
      {
        ...
        int i = 0;
        if (bool) {
          i = 0 + CodedOutputStreamMicro.computeInt32Size(1, getStartToken());
        }
        if (hasEndToken()) {
          i += CodedOutputStreamMicro.computeInt32Size(2, getEndToken());
        }
        this.cachedSize = i;
        return i;
      }
      ...
      public QuerySegment mergeFrom(CodedInputStreamMicro paramCodedInputStreamMicro)
        throws IOException
      {
        for (;;)
        {
      ...
      extends MessageMicro
    {
      ...
      public int getSerializedSize()
      {
        ...
        int i = 0;
        if (bool) {
          i = 0 + CodedOutputStreamMicro.computeMessageSize(1, getQuerySegment());
        }
        int j = 0;
      ...
      public QuerySegmentAlternatives mergeFrom(CodedInputStreamMicro paramCodedInputStreamMicro)
        throws IOException
      {
        for (;;)
        {
 ...
 * Qualified Name:     com.google.quality.genie.proto.QueryAlternativesProto
