...
public final class PumpkinTaggerResultsProto {
    public static final class ActionArgument
        ...
        public int getSerializedSize() {
            ...
            if (hasType()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeInt32Size(2, getType());
            }
            if (hasUserType()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(3, getUserType());
            }
            if (hasScore()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeFloatSize(4, getScore());
            }
            if (hasValue()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(5, getValue());
            }
            if (hasUnnormalizedValue()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(6, getUnnormalizedValue());
            }
            this.cachedSize = i;
            return i;
        }
    ...
    public static final class HypothesisResult
        ...
        public int getSerializedSize() {
            ...
            int i = 0;
            if (bool) {
                i = 0 + com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(1, getActionExportName());
            }
            if (hasActionName()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(2, getActionName());
            }
            Iterator localIterator = getActionArgumentList().iterator();
            while (localIterator.hasNext()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeMessageSize(3, (PumpkinTaggerResultsProto.ActionArgument) localIterator.next());
            }
            if (hasScore()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeFloatSize(4, getScore());
            }
            if (hasTaggedHypothesis()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(5, getTaggedHypothesis());
            }
            this.cachedSize = i;
            return i;
        }
    ...
    public static final class PumpkinTaggerResults
        ...
        public int getSerializedSize() {
            ...
            while (localIterator.hasNext()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeMessageSize(1, (PumpkinTaggerResultsProto.HypothesisResult) localIterator.next());
            }
            this.cachedSize = i;
            return i;
        }
 ...
 * Qualified Name:     PumpkinTaggerResultsProto
