...
public abstract class PumpkinLoader {
    ...
    public synchronized void init() throws IOException {
        ...
        if (pumpkinConfig != null) {
            com.google.speech.grammar.pumpkin.PumpkinConfigProto.PumpkinConfig config = loadPumpkinConfig();
            if (tagger == null) {
    ...
    protected abstract com.google.speech.grammar.pumpkin.PumpkinConfigProto.PumpkinConfig loadPumpkinConfig()
            throws IOException;
}
