...
public final class PumpkinConfigProto {
    public static final class DecoderConfig
        ...
        public int getSerializedSize() {
            ...
            int i = 0;
            if (bool) {
                i = 0 + com.embryo.protobuf.micro.CodedOutputStreamMicro.computeInt32Size(1, getNumOfActiveStates());
            }
            if (hasOnTheFlyComposition()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeBoolSize(2, getOnTheFlyComposition());
            }
            if (hasRetainOnlyBestHypotheses()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeBoolSize(3, getRetainOnlyBestHypotheses());
            }
            this.cachedSize = i;
            return i;
        }
        ...
        public DecoderConfig mergeFrom(com.embryo.protobuf.micro.CodedInputStreamMicro paramCodedInputStreamMicro)
                throws IOException {
            for (; ; ) {
    ...
    public static final class PumpkinConfig
        ...
        public int getSerializedSize() {
            ...
            int i = 0;
            if (bool) {
                i = 0 + com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(1, getLanguage());
            }
            if (hasValidatorManagerConfig()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeMessageSize(2, getValidatorManagerConfig());
            }
            if (hasDecoderConfig()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeMessageSize(3, getDecoderConfig());
            }
            if (hasInsErrScore()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeFloatSize(4, getInsErrScore());
            }
            if (hasCanonicalizeToFullContacts()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeBoolSize(5, getCanonicalizeToFullContacts());
            }
            this.cachedSize = i;
            return i;
        }
        ...
        public PumpkinConfig mergeFrom(com.embryo.protobuf.micro.CodedInputStreamMicro paramCodedInputStreamMicro)
                throws IOException {
            for (; ; ) {
                int i = paramCodedInputStreamMicro.readTag();
                switch (i) {
    ...
    public static final class PumpkinResource
            extends com.embryo.protobuf.micro.MessageMicro {
        private int cachedSize = -1;
        private com.embryo.protobuf.micro.ByteStringMicro data_ = com.embryo.protobuf.micro.ByteStringMicro.EMPTY;
        ...
        public com.embryo.protobuf.micro.ByteStringMicro getData() {
            return this.data_;
        }
        ...
        public int getSerializedSize() {
            ...
            int i = 0;
            if (bool) {
                i = 0 + com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(1, getName());
            }
            if (hasFilename()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(2, getFilename());
            }
            if (hasData()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeBytesSize(3, getData());
            }
            this.cachedSize = i;
            return i;
        }
        ...
        public PumpkinResource mergeFrom(com.embryo.protobuf.micro.CodedInputStreamMicro paramCodedInputStreamMicro)
                throws IOException {
            for (; ; ) {
                int i = paramCodedInputStreamMicro.readTag();
                switch (i) {
        ...
        public PumpkinResource setData(com.embryo.protobuf.micro.ByteStringMicro paramByteStringMicro) {
            this.hasData = true;
    ...
    public static final class ValidatorManagerConfig
        ...
        public int getSerializedSize() {
            ...
            int i = 0;
            if (bool) {
                i = 0 + com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(1, getResourcePath());
            }
            if (hasContactKeyWords()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(2, getContactKeyWords());
            }
            if (hasDotInEmails()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(3, getDotInEmails());
            }
            if (hasAtInEmails()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(4, getAtInEmails());
            }
            if (hasDotInUrls()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeStringSize(5, getDotInUrls());
            }
            Iterator localIterator = getGrammarList().iterator();
            while (localIterator.hasNext()) {
                i += com.embryo.protobuf.micro.CodedOutputStreamMicro.computeMessageSize(6, (PumpkinConfigProto.PumpkinResource) localIterator.next());
            }
            this.cachedSize = i;
            return i;
        }
        ...
        public ValidatorManagerConfig mergeFrom(com.embryo.protobuf.micro.CodedInputStreamMicro paramCodedInputStreamMicro)
                throws IOException {
            for (; ; ) {
                int i = paramCodedInputStreamMicro.readTag();
                switch (i) {
 ...
 * Qualified Name:     PumpkinConfigProto
