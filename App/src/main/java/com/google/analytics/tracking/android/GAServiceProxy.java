  ...
  implements AnalyticsGmsCoreClient.OnConnectedListener, AnalyticsGmsCoreClient.OnConnectionFailedListener, ServiceProxy
{
  ...
  public void onConnectionFailed(int paramInt, android.content.Intent paramIntent)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getstatic 334	com/google/analytics/tracking/android/GAServiceProxy$ConnectState:PENDING_CONNECTION	Lcom/google/analytics/tracking/android/GAServiceProxy$ConnectState;
    //   6: putfield 77	com/google/analytics/tracking/android/GAServiceProxy:state	Lcom/google/analytics/tracking/android/GAServiceProxy$ConnectState;
    //   9: aload_0
    //   10: getfield 70	com/google/analytics/tracking/android/GAServiceProxy:connectTries	I
    //   13: iconst_2
    //   14: if_icmpge +40 -> 54
    //   17: new 336	java/lang/StringBuilder
    //   20: dup
    //   21: invokespecial 337	java/lang/StringBuilder:<init>	()V
    //   24: ldc_w 339
    //   27: invokevirtual 343	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   30: iload_1
    //   31: invokevirtual 346	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   34: ldc_w 348
    //   37: invokevirtual 343	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   40: invokevirtual 351	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   43: invokestatic 166	com/google/analytics/tracking/android/Log:w	(Ljava/lang/String;)I
    //   46: pop
    //   47: aload_0
    //   48: invokespecial 353	com/google/analytics/tracking/android/GAServiceProxy:fireReconnectAttempt	()V
    //   51: aload_0
    //   52: monitorexit
    //   53: return
    //   54: new 336	java/lang/StringBuilder
    //   57: dup
    //   58: invokespecial 337	java/lang/StringBuilder:<init>	()V
    //   61: ldc_w 339
    //   64: invokevirtual 343	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   67: iload_1
    //   68: invokevirtual 346	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   71: ldc_w 355
    //   74: invokevirtual 343	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   77: invokevirtual 351	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   80: invokestatic 166	com/google/analytics/tracking/android/Log:w	(Ljava/lang/String;)I
    //   83: pop
    //   84: aload_0
    //   85: invokespecial 97	com/google/analytics/tracking/android/GAServiceProxy:useStore	()V
    //   88: goto -37 -> 51
    //   91: astore_3
    //   92: aload_0
    //   93: monitorexit
